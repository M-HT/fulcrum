...
extern "C" void MV2DrawPolygonTASM(CMV2Polygon *_edi1) {
...
// find dot with smallest y
	...
	if (edx1 <= esi1) goto MV2DrawPolygonTASM_Dot1YSmallerDot2Y; // dot1.y <= dot2.y


	if (esi1 <= edi1) goto MV2DrawPolygonTASM_Dot2YSmallest; // dot2.y <(=) dot3.y&dot1.y
	goto MV2DrawPolygonTASM_Dot3YSmallest; // dot3.y <    dot2.y&dot1.y
MV2DrawPolygonTASM_Dot1YSmallerDot2Y:

	if (edx1 >= edi1) goto MV2DrawPolygonTASM_Dot3YSmallest; // dot3.y <    dot1.y&dot2.y
...
// edi = pDot3
	...
	if (eax1 == ebx1) goto MV2DrawPolygonTASM_PolygonType4;


	if (ebx1 == ecx1) goto MV2DrawPolygonTASM_PolygonType3;
	if (ebx1 < ecx1) goto MV2DrawPolygonTASM_PolygonType2;
...
//st0 = 1/YCounter1, st1 = 1/YCounter2, st2 = 1/YCounter
	...
	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT1;
	...
	if ( (( (int32_t)eax1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck1PT1;
	eax1 = - ( (int32_t)eax1 );
MV2DrawPolygonTASM_PerspCheck1PT1:

	if ( (( (int32_t)ebx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck2PT1;
	ebx1 = - ( (int32_t)ebx1 );
MV2DrawPolygonTASM_PerspCheck2PT1:

	if ( (( (int32_t)ecx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck3PT1;
	ecx1 = - ( (int32_t)ecx1 );
MV2DrawPolygonTASM_PerspCheck3PT1:


	if (eax1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT1;


	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT1;


	if (ecx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT1;
...
//st0 = 1/YCounter, st1 = 1/YCounter2, st2 = 1/YCounter1
	...
	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT2;
	...
	if ( (( (int32_t)eax1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck1PT2;
	eax1 = - ( (int32_t)eax1 );
MV2DrawPolygonTASM_PerspCheck1PT2:

	if ( (( (int32_t)ebx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck2PT2;
	ebx1 = - ( (int32_t)ebx1 );
MV2DrawPolygonTASM_PerspCheck2PT2:

	if ( (( (int32_t)ecx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck3PT2;
	ecx1 = - ( (int32_t)ecx1 );
MV2DrawPolygonTASM_PerspCheck3PT2:


	if (eax1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT2;


	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT2;


	if (ecx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT2;
...
//st0 = 1/YCounter2, st1 = 1/YCounter1
	...
	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT3;
	...
	if ( (( (int32_t)eax1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck1PT3;
	eax1 = - ( (int32_t)eax1 );
MV2DrawPolygonTASM_PerspCheck1PT3:

	if ( (( (int32_t)ebx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck2PT3;
	ebx1 = - ( (int32_t)ebx1 );
MV2DrawPolygonTASM_PerspCheck2PT3:

	if ( (( (int32_t)ecx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck3PT3;
	ecx1 = - ( (int32_t)ecx1 );
MV2DrawPolygonTASM_PerspCheck3PT3:


	if (eax1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT3;


	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT3;


	if (ecx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT3;
...
// edi = pDot3
	...
	if (( (int32_t)eax1 ) <= 0) goto MV2DrawPolygonTASM_PolygonNotVisible;
...
//===>                                                                <===
	...
	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT4;
	...
	if ( (( (int32_t)eax1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck1PT4;
	eax1 = - ( (int32_t)eax1 );
MV2DrawPolygonTASM_PerspCheck1PT4:

	if ( (( (int32_t)ebx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck2PT4;
	ebx1 = - ( (int32_t)ebx1 );
MV2DrawPolygonTASM_PerspCheck2PT4:

	if ( (( (int32_t)ecx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTASM_PerspCheck3PT4;
	ecx1 = - ( (int32_t)ecx1 );
MV2DrawPolygonTASM_PerspCheck3PT4:


	if (eax1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT4;


	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT4;


	if (ecx1 >= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspPT4;
...
// ecx = XCounter
	...
	if (( (int32_t)ecx1 ) <= 0) goto MV2DrawPolygonTASM_PerspTNoXLoop; //***********
//	jz		@@PerspTNoXLoop
	...
	if (( (int32_t)ecx1 ) <= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspTFirstRemnantSpan;
	ecx1 = ( dwSpanLength );
...
//ecx = dwNextXCounter ( = CurXCounter )
	...
	if (( (int32_t)eax1 ) <= 0) goto MV2DrawPolygonTASM_PerspTDoRemnantPixel;
	ecx1 = eax1;


	if (( (int32_t)ecx1 ) <= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspTSecondRemnantSpan;
	ecx1 = ( dwSpanLength );
...
// ebp = dtxf
	...
	if (( (int8_t)ecx1 ) != 0) goto MV2DrawPolygonTASM_PerspTXLoop;
...
//st0 = UL, st1 = VL, st2 = UL/ZL, st3 = VL/ZL, st4 = 1/ZL
	...
	if (( (int32_t)ecx1 ) <= ( dwSpanLength )) goto MV2DrawPolygonTASM_PerspTRemnantSpanFollows;
	ecx1 = ( dwSpanLength );
...
// ebp = dtxf
	...
	ecx1 = (ecx1 & 0xffffff00) | (uint8_t)(( (int8_t)ecx1 ) - 1);
	if (( (int8_t)ecx1 ) != 0) goto MV2DrawPolygonTASM_PerspTRemnantPixelXLoop;
...
//pop		edi     		; ScreenX1Offset, edi1 init.
...
//add		esp,4
	...
	if (( (int32_t)eax1 ) <= 0) goto MV2DrawPolygonTASM_NoLinTXLoop;
...
//	or		eax,0000ffh
	...
	if (( (int16_t)ecx1 ) != 0) goto MV2DrawPolygonTASM_LinTXLoop;
	ebp = stack_var00;
