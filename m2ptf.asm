...
public InitFltJumpTableTASM
InitFltJumpTableTASM proc
	...
	ret
endp InitFltJumpTableTASM





public MV2DrawPolygonTfASM
MV2DrawPolygonTfASM proc
		; edi = pPolygon
