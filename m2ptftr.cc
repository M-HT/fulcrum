...
static void *allocated_pointer2 = NULL;
static uint32_t allocated_size2 = 0;

static void *mem_alloc_endptr2(uint32_t size)
{
    if (allocated_pointer2 != NULL)
    {
        if (size <= allocated_size2)
        {
            return (void *) (allocated_size2 + (uintptr_t) allocated_pointer2);
        }

        free(allocated_pointer2);
        allocated_pointer2 = NULL;
    }

    allocated_size2 = (size & 0xffff0000) + 0x10000;
    allocated_pointer2 = malloc(allocated_size2);
    return (void *) (allocated_size2 + (uintptr_t) allocated_pointer2);
}
...
extern "C" void InitFltJumpTableTTrASM(void) {
...
extern "C" void MV2DrawPolygonTfTrASM(CMV2Polygon *_edi1) {
...
// find dot with smallest y
	...
	if (edx1 <= esi1) goto MV2DrawPolygonTfTrASM_Dot1YSmallerDot2Y; // dot1.y <= dot2.y


	if (esi1 <= edi1) goto MV2DrawPolygonTfTrASM_Dot2YSmallest; // dot2.y <(=) dot3.y&dot1.y
	goto MV2DrawPolygonTfTrASM_Dot3YSmallest; // dot3.y <    dot2.y&dot1.y
MV2DrawPolygonTfTrASM_Dot1YSmallerDot2Y:

	if (edx1 >= edi1) goto MV2DrawPolygonTfTrASM_Dot3YSmallest; // dot3.y <    dot1.y&dot2.y

//MV2DrawPolygonTfTrASM_Dot1YSmallest:
	edx2 = eax2;
	esi2 = ebx2;
	edi2 = ecx2;
	goto MV2DrawPolygonTfTrASM_DotsSorted;
MV2DrawPolygonTfTrASM_Dot2YSmallest:
	edx2 = ebx2;
	esi2 = ecx2;
	edi2 = eax2;
	goto MV2DrawPolygonTfTrASM_DotsSorted;
MV2DrawPolygonTfTrASM_Dot3YSmallest:
	edx2 = ecx2;
	esi2 = eax2;
	edi2 = ebx2;
	goto MV2DrawPolygonTfTrASM_DotsSorted;
MV2DrawPolygonTfTrASM_DotsSorted:
...
// edi = pDot3
	...
	if (eax1 == ebx1) goto MV2DrawPolygonTfTrASM_PolygonType4;


	if (ebx1 == ecx1) goto MV2DrawPolygonTfTrASM_PolygonType3;
	if (ebx1 < ecx1) goto MV2DrawPolygonTfTrASM_PolygonType2;


//=============>                <==============
//=============> Polygon Type 1 <==============
//=============>                <==============
//MV2DrawPolygonTfTrASM_PolygonType1:
// edx = pDot1
// esi = pDot2
// edi = pDot3
...
//st0 = 1/YCounter1, st1 = 1/YCounter2, st2 = 1/YCounter
	...
	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT1;
	...
	if ( (( (int32_t)eax1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck1PT1;
	eax1 = - ( (int32_t)eax1 );
MV2DrawPolygonTfTrASM_PerspCheck1PT1:

	if ( (( (int32_t)ebx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck2PT1;
	ebx1 = - ( (int32_t)ebx1 );
MV2DrawPolygonTfTrASM_PerspCheck2PT1:

	if ( (( (int32_t)ecx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck3PT1;
	ecx1 = - ( (int32_t)ecx1 );
MV2DrawPolygonTfTrASM_PerspCheck3PT1:


	if (eax1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT1;


	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT1;


	if (ecx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT1;

	goto MV2DrawPolygonTfTrASM_LinearPolygonType1;
MV2DrawPolygonTfTrASM_PerspPT1:
...
MV2DrawPolygonTfTrASM_PerspPT1ScanlinerTLoopPass1:
...
//mov		ss:[esp].CMV2ScanlinerPerspT__dwXCounter,ecx
	SPT->CMV2ScanlinerPerspT__dwScreenX1Offset = esi1;
	SPT->CMV2ScanlinerPerspT__dwXCounter = ecx1;
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PerspPT1ScanlinerTLoopPass1;
...
MV2DrawPolygonTfTrASM_PerspPT1ScanlinerTLoopPass2:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//mov		ss:[esp].CMV2ScanlinerPerspT__dwXCounter,ecx
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PerspPT1ScanlinerTLoopPass2;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTfTrASM_PerspTYLoop;
MV2DrawPolygonTfTrASM_PolygonType2:
//=============>                <==============
//=============> Polygon Type 2 <==============
//=============>                <==============
// edx = pDot1
...
//st0 = 1/YCounter, st1 = 1/YCounter2, st2 = 1/YCounter1
	...
	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT2;
	...
	if ( (( (int32_t)eax1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck1PT2;
	eax1 = - ( (int32_t)eax1 );
MV2DrawPolygonTfTrASM_PerspCheck1PT2:

	if ( (( (int32_t)ebx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck2PT2;
	ebx1 = - ( (int32_t)ebx1 );
MV2DrawPolygonTfTrASM_PerspCheck2PT2:

	if ( (( (int32_t)ecx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck3PT2;
	ecx1 = - ( (int32_t)ecx1 );
MV2DrawPolygonTfTrASM_PerspCheck3PT2:


	if (eax1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT2;


	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT2;


	if (ecx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT2;

	goto MV2DrawPolygonTfTrASM_LinearPolygonType2;
MV2DrawPolygonTfTrASM_PerspPT2:
...
MV2DrawPolygonTfTrASM_PerspPT2ScanlinerTLoopPass1:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//mov		ss:[esp].CMV2ScanlinerPerspT__dwXCounter,ecx
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PerspPT2ScanlinerTLoopPass1;
...
MV2DrawPolygonTfTrASM_PerspPT2ScanlinerTLoopPass2:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//mov		ss:[esp].CMV2ScanlinerPerspT__dwXCounter,ecx
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PerspPT2ScanlinerTLoopPass2;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTfTrASM_PerspTYLoop;
MV2DrawPolygonTfTrASM_PolygonType3:
//=============>                <==============
//=============> Polygon Type 3 <==============
//=============>                <==============
// edx = pDot1
...
//st0 = 1/YCounter2, st1 = 1/YCounter1
	...
	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT3;
	...
	if ( (( (int32_t)eax1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck1PT3;
	eax1 = - ( (int32_t)eax1 );
MV2DrawPolygonTfTrASM_PerspCheck1PT3:

	if ( (( (int32_t)ebx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck2PT3;
	ebx1 = - ( (int32_t)ebx1 );
MV2DrawPolygonTfTrASM_PerspCheck2PT3:

	if ( (( (int32_t)ecx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck3PT3;
	ecx1 = - ( (int32_t)ecx1 );
MV2DrawPolygonTfTrASM_PerspCheck3PT3:


	if (eax1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT3;


	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT3;


	if (ecx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT3;

	goto MV2DrawPolygonTfTrASM_LinearPolygonType3;
MV2DrawPolygonTfTrASM_PerspPT3:
...
MV2DrawPolygonTfTrASM_PerspPT3ScanlinerTLoopPass1:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//mov		ss:[esp].CMV2ScanlinerPerspT__dwXCounter,ecx
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PerspPT3ScanlinerTLoopPass1;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTfTrASM_PerspTYLoop;
MV2DrawPolygonTfTrASM_PolygonType4:
//=============>                <==============
//=============> Polygon Type 4 <==============
//=============>                <==============
// edx = pDot1
...
// edi = pDot3
	...
	if (( (int32_t)eax1 ) <= 0) goto MV2DrawPolygonTfTrASM_PolygonNotVisible;
...
//===>                                                                <===
	...
	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT4;
	...
	if ( (( (int32_t)eax1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck1PT4;
	eax1 = - ( (int32_t)eax1 );
MV2DrawPolygonTfTrASM_PerspCheck1PT4:

	if ( (( (int32_t)ebx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck2PT4;
	ebx1 = - ( (int32_t)ebx1 );
MV2DrawPolygonTfTrASM_PerspCheck2PT4:

	if ( (( (int32_t)ecx1 ) - ( 0 )) >= 0) goto MV2DrawPolygonTfTrASM_PerspCheck3PT4;
	ecx1 = - ( (int32_t)ecx1 );
MV2DrawPolygonTfTrASM_PerspCheck3PT4:


	if (eax1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT4;


	if (ebx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT4;


	if (ecx1 >= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspPT4;

	goto MV2DrawPolygonTfTrASM_LinearPolygonType4;
MV2DrawPolygonTfTrASM_PerspPT4:
...
MV2DrawPolygonTfTrASM_PerspPT4ScanlinerTLoopPass1:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//mov		ss:[esp].CMV2ScanlinerPerspT__dwXCounter,ecx
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PerspPT4ScanlinerTLoopPass1;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTfTrASM_PerspTYLoop;
MV2DrawPolygonTfTrASM_PerspTYLoop:
//mov		ecx,ss:[esp].CMV2ScanlinerPerspT__dwXCounter
//mov		edi,ss:[esp].CMV2ScanlinerPerspT__dwScreenX1Offset
	ecx1 = SPT->CMV2ScanlinerPerspT__dwXCounter;
	edi1 = SPT->CMV2ScanlinerPerspT__dwScreenX1Offset;

	iPixelCounter = iPixelCounter + ecx1; //***********

// ecx = XCounter

	if (( (int32_t)ecx1 ) <= 0) goto MV2DrawPolygonTfTrASM_PerspTNoXLoop; //***********
//	jz		@@PerspTNoXLoop
	dwXCounter = ecx1;

	XLD = (XLoopData *) mem_alloc_endptr2(dwXCounter * sizeof(XLoopData));

	eax1 = ecx1;
	dwScanlineXCounter = ecx1;


	if (( (int32_t)ecx1 ) <= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspTFirstRemnantSpan;
	ecx1 = ( dwSpanLength );
MV2DrawPolygonTfTrASM_PerspTFirstRemnantSpan:
...
//ecx = dwNextXCounter ( = CurXCounter )
	...
	if (( (int32_t)eax1 ) <= 0) goto MV2DrawPolygonTfTrASM_PerspTDoRemnantPixel;
	ecx1 = eax1;


	if (( (int32_t)ecx1 ) <= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspTSecondRemnantSpan;
	ecx1 = ( dwSpanLength );
MV2DrawPolygonTfTrASM_PerspTSecondRemnantSpan:
...
MV2DrawPolygonTfTrASM_PerspTSpanLoop:
//st0 = UL, st1 = VL, st2 = UR/ZR, st3 = VR/ZR, st4 = 1/ZR
	fpu_reg15 = 1.0f;
	fpu_reg15 = fpu_reg15 / fpu_reg10;
...
MV2DrawPolygonTfTrASM_PerspTXLoop:
// eax = col
// ebx = txf			| dty 	| dtX
// ecx = tyf			|		| XCounter
// edx = pTexture	| ty	| tx
...
//push	ebx
	...
	if (( (int8_t)ecx1 ) != 0) goto MV2DrawPolygonTfTrASM_PerspTXLoop;
...
//st0 = UL, st1 = VL, st2 = UL/ZL, st3 = VL/ZL, st4 = 1/ZL
	...
	if (( (int32_t)dwScanlineXCounter ) <= ( 0 )) goto MV2DrawPolygonTfTrASM_PerspTDoRemnantPixel;

	ecx1 = dwScanlineXCounter;
	eax1 = ecx1;

	if (( (int32_t)ecx1 ) <= ( dwSpanLength )) goto MV2DrawPolygonTfTrASM_PerspTRemnantSpanFollows;
	ecx1 = ( dwSpanLength );
MV2DrawPolygonTfTrASM_PerspTRemnantSpanFollows:
...
//st0 = UL, st1 = VL, st2 = UR/ZR, st3 = VR/ZR, st4 = 1/ZR
	...
	goto MV2DrawPolygonTfTrASM_PerspTSpanLoop;
MV2DrawPolygonTfTrASM_PerspTDoRemnantPixel:
	ebx1 = dwTextureUdX;
	eax1 = dwTextureVdX;
	ebp = ebx1;
	esi1 = eax1;
...
MV2DrawPolygonTfTrASM_PerspTRemnantPixelXLoop:
// eax = col
// ebx = txf			| dty 	| dtX
// ecx = tyf			|		| XCounter
// edx = pTexture	| ty	| tx
...
//push	ebx
	...
	ecx1 = (ecx1 & 0xffffff00) | (uint8_t)(( (int8_t)ecx1 ) - 1);
	if (( (int8_t)ecx1 ) != 0) goto MV2DrawPolygonTfTrASM_PerspTRemnantPixelXLoop;

//	mov		ds:[4*edi - 4],0ffffffh

	ebp = dwXCounter;

MV2DrawPolygonTfTrASM_PerspFltLoop:
...
//pop		ecx							; pTexture>>2	|ty		|tx
	esi1 = XLD->txf; // txf
	ecx1 = XLD->pTexture; // pTexture>>2	|ty		|tx

	esi1 = esi1 >> ( 29 );
	edx1 = ecx1;
//mov		edi,offset PerspFltJumpTableX
	edx1 = (edx1 & 0xffffff00) | (uint8_t)(( (uint8_t)edx1 ) + 1);
...
//pop		ebx						; tyf
	...
	edx1 = (edx1 & 0xffffff00) | (uint8_t)(( (uint8_t)edx1 ) - 1);
	ebx1 = ebx1 >> ( 29 );
	edx1 = set_high_byte(edx1, ( (uint8_t)(edx1 >> 8) ) + 1);
	eax1 = pcTexture[ecx1];
	ecx1 = pcTexture[edx1];
...
//	jmp		[ebx]
	...
	case 1:
//PerspFltCaseX1:
	eax1 = pcTexture[ecx1]; // 1. Texel
	esi1 = pcTexture[edx1]; // 2. Texel
	ebx1 = eax1;
	edi1 = esi1;

	ecx1 = set_high_byte(ecx1, ( (uint8_t)(ecx1 >> 8) ) + 1);
	edx1 = set_high_byte(edx1, ( (uint8_t)(edx1 >> 8) ) + 1);

	eax1 = eax1 & ( 0x0f8f8f8f8 );
	esi1 = esi1 & ( 0x0f8f8f8f8 );
	ebx1 = ebx1 & ( 0x007070707 );
	edi1 = edi1 & ( 0x007070707 );
	...
	ecx1 = pcTexture[ecx1]; // 3. Texel
	ebx1 = ebx1 & ( 0x0f8f8f8f8 );
	esi1 = pcTexture[edx1]; // 4. Texel
	eax1 = eax1 + ebx1;

	edx1 = ecx1;
	edi1 = esi1;

	ecx1 = ecx1 & ( 0x0f8f8f8f8 );
	esi1 = esi1 & ( 0x0f8f8f8f8 );
	edx1 = edx1 & ( 0x007070707 );
	edi1 = edi1 & ( 0x007070707 );
...
//PerspFltCaseY0:
	eax1 = ( eax1 * 8 );
//pop		edi
	edi1 = XLD->destination;
//add		esp, size XLoopData
	XLD++;
	eax1 = eax1 >> ( 6 );

	eax1 = eax1 & ( 0x0fefefefe );
	eax1 = eax1 >> ( 1 );
	dwTemp = eax1;
	eax1 = pcBackBuffer[edi1];
	eax1 = eax1 & ( 0x0fefefefe );
	eax1 = eax1 >> ( 1 );
	eax1 = eax1 + dwTemp;

	pcBackBuffer[edi1] = eax1;
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PerspFltLoop;
//	jmp		@@PerspFltDone
	break;
	case 1:
//PerspFltCaseY1:
	ebx1 = eax1;
	edx1 = ecx1;
	eax1 = eax1 & ( 0x0c7c7c7c7 );
	ecx1 = ecx1 & ( 0x0c7c7c7c7 );
	ebx1 = ebx1 & ( 0x038383838 );
	edx1 = edx1 & ( 0x038383838 );
...
MV2DrawPolygonTfTrASM_PerspTNoXLoop:
...
//add		esp,CMV2ScanlinerPerspT__size
	...
	if (( (int32_t)dwYCounter ) != 0) goto MV2DrawPolygonTfTrASM_PerspTYLoop;

//mov		esp,dwOldESP

MV2DrawPolygonTfTrASM_PolygonNotVisible:

	goto MV2DrawPolygonTfTrASM_Done;
MV2DrawPolygonTfTrASM_LinearPolygonType1:
//======================> 				<==============================
//======================> 				<==============================
//======================> 				<==============================
//======================> 				<==============================
...
MV2DrawPolygonTfTrASM_PT1YloopPass1:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx =
// edx =
...
//fild	dword ptr [esp]
	...
	eax1 = eax1 << ( 12 );
//push	esi
	LPD->iScreenX1Offset = esi1;

	fpu_reg16 = fpu_reg10;
	{ float tmp = fpu_reg16; fpu_reg16 = fpu_reg15; fpu_reg15 = tmp; }
	fpu_reg15 = fpu_reg15 - fpu_reg16;
//push	edi
	LPD->iScreenX2Offset = edi1;
...
//fcomp
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PT1YloopPass1;
//stack:
...
MV2DrawPolygonTfTrASM_PT1YloopPass2:
	eax1 = eax1 >> ( 12 );
//sub		esp,size LinearPolygonData
	LPD--;
//push	eax
...
//fcomp
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PT1YloopPass2;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTfTrASM_LinTYLoop;
MV2DrawPolygonTfTrASM_LinearPolygonType2:
//=============>                <==============
//=============> Linear		   <==============
//=============> Polygon Type 2 <==============
//=============>                <==============
...
MV2DrawPolygonTfTrASM_PT2YloopPass1:
	eax1 = eax1 >> ( 12 );
//sub		esp,size LinearPolygonData
	LPD--;
//push	eax
...
//fcomp
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PT2YloopPass1;
//stack:
//TextureV, ScreenX2Offset, ScreenX1Offset, TextureU
...
MV2DrawPolygonTfTrASM_PT2YloopPass2:
	eax1 = eax1 >> ( 12 );
//sub		esp,size LinearPolygonData
//push	eax
	LPD->iTextureU = eax1;
...
//fcomp
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PT2YloopPass2;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTfTrASM_LinTYLoop;
MV2DrawPolygonTfTrASM_LinearPolygonType3:
//=============>                <==============
//=============> Linear		   <==============
//=============> Polygon Type 3 <==============
//=============>                <==============
...
MV2DrawPolygonTfTrASM_PT3YloopPass1:
	eax1 = eax1 >> ( 12 );
//sub		esp,size LinearPolygonData
	LPD--;
//push	eax
...
//fcomp
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PT3YloopPass1;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTfTrASM_LinTYLoop;
MV2DrawPolygonTfTrASM_LinearPolygonType4:
//=============>                <==============
//=============> Linear		   <==============
//=============> Polygon Type 4 <==============
//=============>                <==============
...
MV2DrawPolygonTfTrASM_PT4YloopPass1:
	eax1 = eax1 >> ( 12 );
//sub		esp,size LinearPolygonData
	LPD--;
//push	eax
...
//fcomp
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_PT4YloopPass1;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTfTrASM_LinTYLoop;
MV2DrawPolygonTfTrASM_LinTYLoop:
	eax1 = dwTextureUdX;
	edx1 = dwTextureVdX;

	eax1 = (eax1 << ( 16 )) | (eax1 >> (32 - ( 16 )));
	edx1 = (edx1 << ( 16 )) | (edx1 >> (32 - ( 16 ))); // U!

	esi1 = edx1;
//mov		ebx,ss:[esp + 12]	; TextureU
	ebx1 = LPD->iTextureU; // TextureU
	ebp = eax1;

	ebx1 = (ebx1 << ( 16 )) | (ebx1 >> (32 - ( 16 )));
	esi1 = esi1 & ( 0x0ffff0000 ); // esi init.	(!)
	ebx1 = set_high_byte(ebx1, ( (uint8_t)edx1 ));
	//edx1 = pcTexture; // (!)
	edx1 = 0;

	ebp = ebp & ( 0x0ffff0000 ); // ebp init.	(!)
	edx1 = (edx1 & 0xffffff00) | (uint8_t)(( (uint8_t)ebx1 )); // (!)
	ebx1 = (ebx1 & 0xffffff00) | (uint8_t)(( (uint8_t)eax1 )); // ebx init.

//pop		ecx				; TextureV
//pop		eax				; ScreenX2Offset
//pop		edi     		; ScreenX1Offset, edi init.
	ecx1 = LPD->iTextureV; // TextureV
	eax1 = LPD->iScreenX2Offset; // ScreenX2Offset
	edi1 = LPD->iScreenX1Offset; // ScreenX1Offset, edi init.

	ecx1 = (ecx1 << ( 16 )) | (ecx1 >> (32 - ( 16 ))); // ecx init.
//add		esp,4
	LPD++;
	eax1 = eax1 - edi1; // eax init.
	edx1 = set_high_byte(edx1, ( (uint8_t)ecx1 )); // edx init.

	iPixelCounter = iPixelCounter + eax1; //**************** profiling


	if (( (int32_t)eax1 ) <= 0) goto MV2DrawPolygonTfTrASM_NoLinTXLoop;
	dwXCounter = eax1;

	XLD = (XLoopData *) mem_alloc_endptr2(dwXCounter * sizeof(XLoopData));

	ecx1 = (ecx1 & 0xffff0000) | (uint16_t)(( (uint16_t)eax1 ));
	stack_var00 = ebp;

MV2DrawPolygonTfTrASM_LinTXLoop:
//*eax = counter
//*ebx =	txf				|dty	|dtx
//*ecx = tyf				|       |col
//*edx = pTexture		|ty		|tx
...
//push	ebx
	...
	if (( (int16_t)ecx1 ) != 0) goto MV2DrawPolygonTfTrASM_LinTXLoop;

	ebp = dwXCounter;

MV2DrawPolygonTfTrASM_LinearFltLoop:
// eax = pTexture>>2	|ty		|tx
// ebx = pTexture>>2	|ty		|tx
// ecx =
// edx =
...
//add		esp, size XLoopData
	...
	pcBackBuffer[edi1] = eax1;
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTfTrASM_LinearFltLoop;
//	jmp		@@LinearFltDone
	break;
	case 1:
//LinearFltCaseY1:
...
MV2DrawPolygonTfTrASM_NoLinTXLoop:
	dwYCounter = ( (int32_t)dwYCounter ) - 1;
	if (( (int32_t)dwYCounter ) != 0) goto MV2DrawPolygonTfTrASM_LinTYLoop;

MV2DrawPolygonTfTrASM_Done:
