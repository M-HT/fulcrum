...
EXTRN	pAngleJoinTab		:BYTE
EXTRN	pLightBrightnessTab	:DWORD
EXTRN	pBumpShadeLookup	:BYTE

align 32

pBackBumpBuffer				dd 1600 dup(0)
...
public MV2DrawPolygonTBASM
MV2DrawPolygonTBASM proc
		; edi = pPolygon
	...
	mov		pcTexture,edx
	mov		edx,ds:[edi].CMV2Polygon__m_pcBumpmap
	shr		edx,1
	mov		pcBumpmap,edx
...
@@PerspTGXLoop:
	...
	and		edx,0ffffh
	add		edx,pcBumpmap
	mov		ds:[edi].pBackBumpBuffer,edx  ; ->pBackBumpBuffer
	mov		edx,eax

	mov     eax,ds:[4*edx]
	mov		ds:[edi].pBackTextureBuffer,eax
...
; ebp = 				|NAngle |NAnglef
	...
	mov		eax,ds:[edi].pBackBumpBuffer
	xor		ecx,ecx
	xor		bh,ds:[2*eax]						;UBump
	mov		ch,ds:[2*eax + 1]					;VBump
	sub		ebx,128*256
	sub		ecx,128*256
	xor		eax,eax
	add		ebx,edx								;UAngle + UBump
	add		ecx,esi								;VAngle + VBump
	...
	mov		ah,ch
	xor		ebx,ebx
	mov		bl,ds:[eax].pAngleJoinTab			;pAngleJoin
	jmp		@@PerspAmbient
@@PerspAmbientBump:
	xor		ebx,ebx
@@PerspAmbient:
	mov		ebx,ds:[4*ebx].pLightBrightnessTab	;Helligkeit
	mov		ds:[edi].pBackShadeBuffer,ebx		;ShadeBuffer
...
@@PerspShadeLoop:
	...
	mov		bl,ds:[ecx].pBumpShadeLookup	; g
	mov		bh,ds:[eax].pBumpShadeLookup	; r
	shl		ebx,8
	mov		bl,ds:[edx].pBumpShadeLookup	; b
