...
//=============> Polygon Type 1 <==============
//=============>                <==============
//MV2DrawPolygonTGASM_PolygonType1:
// edx = pDot1
// esi = pDot2
// edi = pDot3
...
MV2DrawPolygonTGASM_PerspPT1ScanlinerTGLoopPass1:
...
MV2DrawPolygonTGASM_PerspPT1ScanlinerTGLoopPass2:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//fcomp
	...
	fpu_reg13 = fG1;
	fpu_reg14 = fR1;
MV2DrawPolygonTGASM_PerspPT1GouraudPass1:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_PerspPT1GouraudPass1;
//fcompp
//fcomp
	...
	fpu_reg13 = fG3;
	fpu_reg14 = fR3;
MV2DrawPolygonTGASM_PerspPT1GouraudPass2:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_PerspPT1GouraudPass2;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTGASM_DoPerspTGYLoop;
MV2DrawPolygonTGASM_PolygonType2:
//=============>                <==============
//=============> Polygon Type 2 <==============
//=============>                <==============
// edx = pDot1
...
MV2DrawPolygonTGASM_PerspPT2ScanlinerTGLoopPass1:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//fcomp
	...
	fpu_reg13 = fG1;
	fpu_reg14 = fR1;
MV2DrawPolygonTGASM_PerspPT2GouraudPass1_2:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_PerspPT2GouraudPass1_2;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTGASM_DoPerspTGYLoop;
MV2DrawPolygonTGASM_PolygonType3:
//=============>                <==============
//=============> Polygon Type 3 <==============
//=============>                <==============
// edx = pDot1
...
MV2DrawPolygonTGASM_PerspPT3ScanlinerTGLoop:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//fcomp
	...
	fpu_reg13 = fG1;
	fpu_reg14 = fR1;
MV2DrawPolygonTGASM_PerspPT3Gouraud:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_PerspPT3Gouraud;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTGASM_DoPerspTGYLoop;
MV2DrawPolygonTGASM_PolygonType4:
//=============>                <==============
//=============> Polygon Type 4 <==============
//=============>                <==============
// edx = pDot1
...
MV2DrawPolygonTGASM_PerspPT4ScanlinerTGLoop:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
//fcomp
	...
	fpu_reg13 = fG1;
	fpu_reg14 = fR1;
MV2DrawPolygonTGASM_PerspPT4Gouraud:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_PerspPT4Gouraud;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTGASM_DoPerspTGYLoop;
MV2DrawPolygonTGASM_DoPerspTGYLoop:
//================> 								<=====================
//================> 								<=====================
//================> 	Perspective					<=====================
...
MV2DrawPolygonTGASM_PerspTGSpanLoop:
//st0 = UL, st1 = VL, st2 = UR/ZR, st3 = VR/ZR, st4 = 1/ZR
	fpu_reg15 = 1.0f;
	fpu_reg15 = fpu_reg15 / fpu_reg10;
...
MV2DrawPolygonTGASM_PerspTGNoXLoop:

//add		esp,CMV2ScanlinerPerspTG__size
	SPTG++;

	dwYCounter = ( (int32_t)dwYCounter ) - 1;
	if (( (int32_t)dwYCounter ) != 0) goto MV2DrawPolygonTGASM_PerspTGYLoop;

//mov		esp,dwOldESP

MV2DrawPolygonTGASM_PolygonNotVisible:

	goto MV2DrawPolygonTGASM_Done;
MV2DrawPolygonTGASM_LinearPolygonType1:
//======================> 				<==============================
//======================> 				<==============================
//======================> 				<==============================
//======================> 				<==============================
...
MV2DrawPolygonTGASM_LinPT1TexturePass1:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
MV2DrawPolygonTGASM_LinPT1TexturePass2:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
// st4 = 2^20, st5 = 2^-20
	...
	fpu_reg13 = fG1;
	fpu_reg14 = fR1;
MV2DrawPolygonTGASM_LinPT1GouraudPass1:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_LinPT1GouraudPass1;
//fcompp
//fcomp
	...
	fpu_reg13 = fG3;
	fpu_reg14 = fR3;
MV2DrawPolygonTGASM_LinPT1GouraudPass2:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_LinPT1GouraudPass2;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTGASM_DoLinTGYLoop;
MV2DrawPolygonTGASM_LinearPolygonType2:
//=============>                <==============
//=============> Linear		   <==============
//=============> Polygon Type 2 <==============
//=============>                <==============
...
MV2DrawPolygonTGASM_LinPT2TexturePass1:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
// st4 = 2^20, st5 = 2^-20
	...
	fpu_reg13 = fG1;
	fpu_reg14 = fR1;
MV2DrawPolygonTGASM_LinPT2GouraudPass1_2:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_LinPT2GouraudPass1_2;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTGASM_DoLinTGYLoop;
MV2DrawPolygonTGASM_LinearPolygonType3:
//=============>                <==============
//=============> Linear		   <==============
//=============> Polygon Type 3 <==============
//=============>                <==============
...
MV2DrawPolygonTGASM_LinPT3Texture:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
// st4 = 2^20, st5 = 2^-20
	...
	fpu_reg13 = fG1;
	fpu_reg14 = fR1;
MV2DrawPolygonTGASM_LinPT3Gouraud:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_LinPT3Gouraud;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTGASM_DoLinTGYLoop;
MV2DrawPolygonTGASM_LinearPolygonType4:
//=============>                <==============
//=============> Linear		   <==============
//=============> Polygon Type 4 <==============
//=============>                <==============
...
MV2DrawPolygonTGASM_LinPT4Texture:
// eax = x1f (20 bit fraction)
// ebx = x2f (20 bit fraction)
// ecx = XCounter (init. BackBuffer + YOffset + X2)
// edx =
...
// st4 = 2^20, st5 = 2^-20
	...
	fpu_reg13 = fG1;
	fpu_reg14 = fR1;
MV2DrawPolygonTGASM_LinPT4Gouraud:
// eax =
// ebx =
// ecx =
// edx =
...
// st0 = R, st1 = G, st2 = B, st3 = 2^20, st4 = 2^-20
	...
	ebp = ( (int32_t)ebp ) - 1;
	if (( (int32_t)ebp ) != 0) goto MV2DrawPolygonTGASM_LinPT4Gouraud;
...
//ffree	st(0)
	...
	goto MV2DrawPolygonTGASM_DoLinTGYLoop;
MV2DrawPolygonTGASM_DoLinTGYLoop:
//================> 								<=====================
//================> 								<=====================
//================> 	Linear						<=====================
//================>  Texture Gouraud InnerLoop	<=====================
...
MV2DrawPolygonTGASM_LinTGNoXLoop:
//add		esp,CMV2ScanlinerLinTG__size
	SLTG++;

	dwYCounter = ( (int32_t)dwYCounter ) - 1;
	if (( (int32_t)dwYCounter ) != 0) goto MV2DrawPolygonTGASM_LinTGYLoop;

//mov		esp,dwOldESP
MV2DrawPolygonTGASM_Done:
